            ...
            <div className="container">
                ...
                <Row>
                    <Col lg={4} className="col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                        <Link href="#"><a className="logo-footer text-dark">Landrick<span className="text-primary">.</span></a></Link>
                        ...
                        <ul className="list-unstyled social-icon social mb-0 mt-4">
                            <li className="list-inline-item"><Link href="#" className="rounded mr-1"><i className="mdi mdi-facebook" title="Facebook"></i></Link></li>
                            <li className="list-inline-item"><Link href="#" className="rounded mr-1"><i className="mdi mdi-instagram" title="Instagram"></i></Link></li>
                            <li className="list-inline-item"><Link href="#" className="rounded"><i className="mdi mdi-twitter" title="Twitter"></i></Link></li>
                        </ul>
                    </Col>
                    ...
                    {/* <Col lg={2} md={4} className="col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        ...
                        <ul className="list-unstyled footer-list mt-4">
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Aboutus</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Services</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Team</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Pricing</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Features</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> FAQ</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Blog</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Login</Link></li>
                        </ul>
                    </Col>
                    ...
                    <Col lg={3} md={4} className="col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        ...
                        <ul className="list-unstyled footer-list mt-4">
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Privacy Protection</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Safe Payments</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Terms of Services</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Documentation</Link></li>
                            <li><Link href="#" className="text-muted"><i className="mdi mdi-chevron-right mr-1"></i> Privacy Policy</Link></li>
                        </ul>
                    </Col>
